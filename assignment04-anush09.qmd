...
1. Used AI for code cleaning and sorting errors.
2. Used it for figuring out some plotting issues in the last cell.
...
try:
    ...
    # Actualy not needed for GLR but I added it when I was previously using LR.
